...
export default async function GlobalHeaderEditorPage() {
  ...
  const setting = await getGlobalSettingForAdmin(SCHEMA_KEYS.GLOBAL_HEADER);
  ...
  return (
    <div className="min-h-screen bg-slate-100 p-8">
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <div>
          <h1 className="text-2xl font-semibold">Edit Global Header</h1>
          <p className="text-sm text-muted-foreground">
            Configure `global.header.v1` draft content and publish independently.
          </p>
        </div>
