...
export const metadata = {
  title: ADMIN_METADATA_PAGE_TITLE_LABELS.settingsContactPage,
};

export const dynamic = 'force-dynamic';

export default async function GlobalContactPageEditorPage() {
  ...
  return (
    <AdminContent>
      <AdminPageHeader
        title="Contact Page"
        description="Configure `global.contact_page.v1` form copy, field behavior, and recipient email."
      />
