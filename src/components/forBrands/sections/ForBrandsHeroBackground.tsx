...
export function ForBrandsHeroBackground() {
  const uid = useId().replace(/:/g, '');
  const ids = {
    mask: `for-brands-hero-mask-${uid}`,
    blur0: `for-brands-hero-blur0-${uid}`,
    blur1: `for-brands-hero-blur1-${uid}`,
    blur2: `for-brands-hero-blur2-${uid}`,
    blur3: `for-brands-hero-blur3-${uid}`,
    blur4: `for-brands-hero-blur4-${uid}`,
    blur5: `for-brands-hero-blur5-${uid}`,
    gradient1: `for-brands-hero-gradient1-${uid}`,
  };
