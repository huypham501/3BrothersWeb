...
export function ForBrandsCaseStudiesBackground() {
  const uid = useId().replace(/:/g, '');
  const ids = {
    mask: `for-brands-case-studies-mask-${uid}`,
    blur0: `for-brands-case-studies-blur0-${uid}`,
    blur1: `for-brands-case-studies-blur1-${uid}`,
    blur2: `for-brands-case-studies-blur2-${uid}`,
    blur3: `for-brands-case-studies-blur3-${uid}`,
    blur4: `for-brands-case-studies-blur4-${uid}`,
    blur5: `for-brands-case-studies-blur5-${uid}`,
    gradient: `for-brands-case-studies-gradient-${uid}`,
  };

  return (
    <BackgroundWrapper>
      <svg viewBox="0 0 1440 1155" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice">
        <mask id={ids.mask} maskUnits="userSpaceOnUse" x="0" y="0" width="1440" height="1155" style={{ maskType: 'alpha' }}>
          <rect width="1440" height="1155" fill={`url(#${ids.gradient})`} />
          <rect width="1440" height="1155" fill="#061530" />
        </mask>
        ...
        <defs>
          ...
          <linearGradient id={ids.gradient} x1="720" y1="0" x2="720" y2="1155" gradientUnits="userSpaceOnUse">
